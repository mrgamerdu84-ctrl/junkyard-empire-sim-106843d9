...
export const ROADS = [
  ...
  // Path 3 — Avenue horizontale principale (haut, traverse la map d'est en ouest, contourne le rond-point par le nord)
  "M 20 295 L 760 280 Q 850 275 880 470 Q 900 540 880 610 Q 850 800 760 790 L 20 770",
  // Path 4 — Avenue horizontale principale (bas), légèrement diagonale
  "M 1900 290 L 1080 280 Q 990 275 970 460 Q 950 540 970 620 Q 990 800 1080 790 L 1900 770",
  // Path 5 — Axe vertical Nord-Sud passant par le centre, contourne le rond-point par l'est
  "M 945 20 L 935 430 Q 935 470 970 490 Q 1020 510 1060 540 Q 1020 570 970 590 Q 935 610 935 650 L 945 1060",
];
