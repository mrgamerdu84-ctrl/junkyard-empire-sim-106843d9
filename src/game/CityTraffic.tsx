...
// du centre, à DROITE de son sens de marche.
const LANE_HALF = 11;

/* eslint-disable prettier/prettier */

/* ============================================================
 * MY TAXI WORLD — overlay de routes
 * viewBox SVG 1920×1080. preserveAspectRatio="xMidYMid slice".
 * Les 3 premiers paths sont les artères historiques (compat). Les
 * suivants forment une vraie grille urbaine + diagonales pour que
 * TOUTES les routes de la carte soient utilisées par le trafic et que
 * les véhicules circulent partout (centre, périphérie, axes traversants).
 * ============================================================ */
export const ROADS = [
  // 0 — artère diagonale historique (NE → SW)
  ...
  // 1 — petite boucle historique (auparavant exclue)
  ...
  // 2 — artère diagonale historique (SW → NE)
  ...
  // === Grille urbaine — horizontales (toute la largeur) ===
  "M 0 140 L 1920 140",          // 3 — boulevard nord
  "M 0 320 L 1920 320",          // 4 — av. nord-centre
  "M 0 540 L 1920 540",          // 5 — av. centrale (équateur)
  "M 0 760 L 1920 760",          // 6 — av. sud-centre
  "M 0 940 L 1920 940",          // 7 — boulevard sud
  // === Grille urbaine — verticales (toute la hauteur) ===
  "M 240 0 L 240 1080",          // 8 — rue ouest
  "M 720 0 L 720 1080",          // 9 — rue centre-ouest
  "M 960 0 L 960 1080",          // 10 — av. centrale
  "M 1200 0 L 1200 1080",        // 11 — rue centre-est
  "M 1680 0 L 1680 1080",        // 12 — rue est
  // === Diagonales pour casser la rigidité de la grille ===
  "M 0 0 L 1920 1080",           // 13 — diag NW-SE
  "M 1920 0 L 0 1080",           // 14 — diag NE-SW
  // === Boucle périphérique ===
  "M 80 80 L 1840 80 L 1840 1000 L 80 1000 Z", // 15 — ring road
];
