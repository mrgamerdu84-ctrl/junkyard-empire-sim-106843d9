...
export function computeTrafficLights(
  ...
  // Feux automatiques désactivés : ils étaient placés via détection
  // d'intersections SVG, ce qui les positionnait au mauvais endroit sur
  // la nouvelle map. On les replacera manuellement plus tard.
  return [];
}
