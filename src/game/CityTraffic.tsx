...
const CARS: CarSpec[] = [
  { color: "#d83a2a", accent: "#7c1c10", duration: 38, delay: -2, pathIdx: 0, scale: 0.64 },
  { color: "#f5c542", accent: "#9c7a1c", duration: 42, delay: -16, pathIdx: 0, scale: 0.66 },
  { color: "#2b6ed8", accent: "#143f7c", duration: 36, delay: -8, pathIdx: 0, flip: true, scale: 0.65 },
  { color: "#e8edf2", accent: "#8a8e94", duration: 40, delay: -24, pathIdx: 0, flip: true, scale: 0.62 },
  { color: "#12151a", accent: "#050607", duration: 18, delay: -2, pathIdx: 1, scale: 0.6 },
  { color: "#3a8a48", accent: "#1c4a22", duration: 20, delay: -10, pathIdx: 1, flip: true, scale: 0.6 },
  { color: "#d97a2a", accent: "#7a3a10", duration: 44, delay: -14, pathIdx: 2, scale: 0.64 },
  { color: "#b81c4a", accent: "#5c0a20", duration: 39, delay: -6, pathIdx: 2, scale: 0.62 },
  { color: "#1a3a6a", accent: "#0a1c40", duration: 46, delay: -22, pathIdx: 2, flip: true, scale: 0.62 },
  { color: "#8f969e", accent: "#3a3e44", duration: 41, delay: -30, pathIdx: 2, flip: true, scale: 0.6 },
  { color: "#ff6b35", accent: "#8f2d10", duration: 43, delay: -12, pathIdx: 0, scale: 0.62 },
  { color: "#4ed6c5", accent: "#187266", duration: 45, delay: -28, pathIdx: 2, scale: 0.58 },
];
